 ...
 *
 */
public class AutomovelDAO<T> extends DAOGenerico<Automovel> implements Serializable {

    public AutomovelDAO() {
        super();
        super.setClassePersistente(Automovel.class);
        super.setOrdem("modelo");//ordem padrao
